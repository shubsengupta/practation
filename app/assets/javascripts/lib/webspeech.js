...
//
  ...
  r.interimText = function(text) {
    //console.log("firing");
    Backbone.Events.trigger('interimTextUpdate', text);
  };

  r.finalText = function(text) {
    //console.log("firing");
    Backbone.Events.trigger('finalTextUpdate', text);
  };
...
//   r.setFinal = function(elem, text) {
//     Backbone.Events.trigger('voiceTrigger', text)
//   };

//   r.setInterim = function(elem, text) {
//     Backbone.Events.trigger('voiceTriggerInterim', text)
//   };
...
//       }
//       r.final_transcript = r.capitalize(r.final_transcript);
//       r.setFinal(r.final_results, r.final_transcript);
//       r.setInterim(r.interim_results, r.interim_transcript);
//       if (!!r.onResult) {
//         r.onResult();
//       }
//     };
